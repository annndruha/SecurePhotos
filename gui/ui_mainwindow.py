...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.filesTree.setMaximumSize(QtCore.QSize(500, 16777215))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../images/icons/key.svg"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actionEnterKey.setIcon(icon)
        self.actionEnterKey.setObjectName("actionEnterKey")
        self.actionEncrypt = QtWidgets.QAction(MainWindow)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../images/icons/lock.svg"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../images/icons/folder_open.svg"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("../images/icons/rotate_left.svg"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("../images/icons/rotate_right.svg"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("../images/icons/open_full.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("../images/icons/zoom_in.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionChangeFit.setIcon(icon6)
        self.actionChangeFit.setObjectName("actionChangeFit")
        self.actionDelete = QtWidgets.QAction(MainWindow)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("../images/icons/delete.svg"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actionDelete.setIcon(icon7)
        self.actionDelete.setObjectName("actionDelete")
        self.actionFoldeDecrypt = QtWidgets.QAction(MainWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("../images/icons/folder.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionFoldeDecrypt.setIcon(icon8)

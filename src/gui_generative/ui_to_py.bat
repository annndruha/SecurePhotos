pyuic5 qt_designer\enterkey.ui -o ui_enterkey.py
pyuic5 qt_designer\mainwindow.ui -o ui_mainwindow.py
pyuic5 qt_designer\folderencrypt.ui -o ui_folderencrypt.py

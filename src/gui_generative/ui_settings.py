...
class Ui_SettingsDialog(object):
    def setupUi(self, SettingsDialog):
        ...
        self.gridLayout.addWidget(self.labelTarget, 2, 2, 1, 1)
        self.enableCopyToTarget = QtWidgets.QCheckBox(self.tab_2)
        self.enableCopyToTarget.setObjectName("enableCopyToTarget")
        self.gridLayout.addWidget(self.enableCopyToTarget, 1, 2, 1, 1)
        self.selectCopyFolder = QtWidgets.QPushButton(self.tab_2)
        self.selectCopyFolder.setObjectName("selectCopyFolder")
        self.gridLayout.addWidget(self.selectCopyFolder, 1, 3, 1, 1)
        self.checkMouseCoords = QtWidgets.QCheckBox(self.tab_2)
        self.checkMouseCoords.setEnabled(True)
        self.checkMouseCoords.setObjectName("checkMouseCoords")
        self.gridLayout.addWidget(self.checkMouseCoords, 0, 2, 1, 1)
    ...
    def retranslateUi(self, SettingsDialog):
        ...
        self.labelTarget.setText(_translate("SettingsDialog", "Target path"))
        ...
        self.checkMouseCoords.setText(_translate("SettingsDialog", "Show mouse coordinates"))
